(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["cryptoPro"] = factory();
  else root["cryptoPro"] = factory();
})(window, function () {
  return /******/ (function (modules) {
    ...
    /******/ return __webpack_require__(
      (__webpack_require__.s = "./crypto-pro.ts")
    );
    /******/
  })(
    /************************************************************************/
 ...
 */
  ...
  \****************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          const exportBase64_1 = __webpack_require__(
            /*! ./exportBase64 */ "./api/certificate/exportBase64.ts"
          );
          const getAlgorithm_1 = __webpack_require__(
            /*! ./getAlgorithm */ "./api/certificate/getAlgorithm.ts"
          );
          const getCadesProp_1 = __webpack_require__(
            /*! ./getCadesProp */ "./api/certificate/getCadesProp.ts"
          );
          const getDecodedExtendedKeyUsage_1 = __webpack_require__(
            /*! ./getDecodedExtendedKeyUsage */ "./api/certificate/getDecodedExtendedKeyUsage.ts"
          );
          const getExtendedKeyUsage_1 = __webpack_require__(
            /*! ./getExtendedKeyUsage */ "./api/certificate/getExtendedKeyUsage.ts"
          );
          const getInfo_1 = __webpack_require__(
            /*! ./getInfo */ "./api/certificate/getInfo.ts"
          );
          const hasExtendedKeyUsage_1 = __webpack_require__(
            /*! ./hasExtendedKeyUsage */ "./api/certificate/hasExtendedKeyUsage.ts"
          );
          const isValid_1 = __webpack_require__(
            /*! ./isValid */ "./api/certificate/isValid.ts"
          );
          class Certificate {
            constructor(
              _cadesCertificate,
            ...
            getOwnerInfo() {
              return getInfo_1.getInfo.call(
                this,
                constants_1.SUBJECT_TAGS_TRANSLATIONS,
                "SubjectName"
              );
            }
            getIssuerInfo() {
              return getInfo_1.getInfo.call(
                this,
                constants_1.ISSUER_TAGS_TRANSLATIONS,
                "IssuerName"
              );
            }
            getExtendedKeyUsage() {
            ...
            getDecodedExtendedKeyUsage() {
              return getDecodedExtendedKeyUsage_1.getDecodedExtendedKeyUsage.call(
                this
              );
            }
            getAlgorithm() {
  ...
  \*****************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          const _afterPluginsLoaded_1 = __webpack_require__(
            /*! ../../helpers/_afterPluginsLoaded */ "./helpers/_afterPluginsLoaded.ts"
          );
          const _extractMeaningfulErrorMessage_1 = __webpack_require__(
            /*! ../../helpers/_extractMeaningfulErrorMessage */ "./helpers/_extractMeaningfulErrorMessage.ts"
          );
          const _generateCadesFn_1 = __webpack_require__(
            /*! ../../helpers/_generateCadesFn */ "./helpers/_generateCadesFn.ts"
          );
          /**
           ...
           */
          exports.exportBase64 = _afterPluginsLoaded_1._afterPluginsLoaded(
            function () {
              const cadesCertificate = this._cadesCertificate;
              return eval(
                _generateCadesFn_1._generateCadesFn(function exportBase64() {
                  let base64;
                  try {
                    base64 =
                      _generateCadesFn_1.__cadesAsyncToken__ +
                      cadesCertificate.Export(0);
                  } catch (error) {
                    console.error(error);
                    throw new Error(
                      _extractMeaningfulErrorMessage_1._extractMeaningfulErrorMessage(
                        error
  ...
  \*****************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
           ...
           */
          exports.getAlgorithm = _afterPluginsLoaded_1._afterPluginsLoaded(
            function () {
              const cadesCertificate = this._cadesCertificate;
              return eval(
                _generateCadesFn_1._generateCadesFn(function getAlgorithm() {
                  const algorithmInfo = {
                    algorithm: null,
                    oid: null,
                  };
                  ...
                  try {
                    ...
                    cadesPublicKey =
                      _generateCadesFn_1.__cadesAsyncToken__ +
                      cadesPublicKey.Algorithm;
                    algorithmInfo.algorithm =
                      _generateCadesFn_1.__cadesAsyncToken__ +
                      cadesPublicKey.FriendlyName;
                    algorithmInfo.oid =
                      _generateCadesFn_1.__cadesAsyncToken__ +
                      cadesPublicKey.Value;
                  } catch (error) {
                    console.error(error);
                    throw new Error(
                      _extractMeaningfulErrorMessage_1._extractMeaningfulErrorMessage(
                        error
                      ) || "Ошибка при получении алгоритма"
                    );
                  }
  ...
  \*****************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
           ...
           */
          exports.getCadesProp = _afterPluginsLoaded_1._afterPluginsLoaded(
            function (propName) {
              const cadesCertificate = this._cadesCertificate;
              return eval(
                _generateCadesFn_1._generateCadesFn(function getCadesProp() {
                  let propertyValue;
                  try {
                    propertyValue =
                      _generateCadesFn_1.__cadesAsyncToken__ +
                      cadesCertificate[propName];
                  } catch (error) {
                    console.error(error);
                    throw new Error(
                      _extractMeaningfulErrorMessage_1._extractMeaningfulErrorMessage(
                        error
                      ) || "Ошибка при обращении к свойству сертификата"
                    );
                  }
  ...
  \*******************************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
           ...
           */
          exports.getDecodedExtendedKeyUsage =
            _afterPluginsLoaded_1._afterPluginsLoaded(function () {
              return __awaiter(this, void 0, void 0, function* () {
                const certificateOids = yield this.getExtendedKeyUsage();
                return certificateOids.reduce(
                  (decodedOids, oidCode) =>
                    Object.assign(Object.assign({}, decodedOids), {
                      [oidCode]: constants_1.OIDS_DICTIONARY[oidCode] || null,
                    }),
                  {}
                );
              });
  ...
  \************************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
           ...
           */
          exports.getExtendedKeyUsage =
            _afterPluginsLoaded_1._afterPluginsLoaded(function () {
              const cadesCertificate = this._cadesCertificate;
              return eval(
                _generateCadesFn_1._generateCadesFn(
                  function getExtendedKeyUsage() {
                    ...
                    try {
                      count =
                        _generateCadesFn_1.__cadesAsyncToken__ +
                        cadesCertificate.ExtendedKeyUsage();
                      count =
                        _generateCadesFn_1.__cadesAsyncToken__ + count.EKUs;
                      count =
                        _generateCadesFn_1.__cadesAsyncToken__ + count.Count;
                      if (count > 0) {
                        while (count > 0) {
                          ...
                          cadesExtendedKeyUsage =
                            _generateCadesFn_1.__cadesAsyncToken__ +
                            cadesExtendedKeyUsage.EKUs;
                          cadesExtendedKeyUsage =
                            _generateCadesFn_1.__cadesAsyncToken__ +
                            cadesExtendedKeyUsage.Item(count);
                          cadesExtendedKeyUsage =
                            _generateCadesFn_1.__cadesAsyncToken__ +
                            cadesExtendedKeyUsage.OID;
  ...
  \************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          const _parseCertInfo_1 = __webpack_require__(
            /*! ../../helpers/_parseCertInfo */ "./helpers/_parseCertInfo.ts"
          );
          const getCadesProp_1 = __webpack_require__(
            /*! ./getCadesProp */ "./api/certificate/getCadesProp.ts"
          );
           ...
           */
          exports.getInfo = _afterPluginsLoaded_1._afterPluginsLoaded(function (
            tags,
            entitiesPath
          ) {
            return __awaiter(this, void 0, void 0, function* () {
              let entities;
              try {
                entities = yield getCadesProp_1.getCadesProp.call(
                  this,
                  entitiesPath
                );
              } catch (error) {
                ...
                throw new Error(
                  _extractMeaningfulErrorMessage_1._extractMeaningfulErrorMessage(
                    error
                  ) || "Ошибка при извлечении информации из сертификата"
                );
              }
  ...
  \************************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
           ...
           */
          exports.hasExtendedKeyUsage =
            _afterPluginsLoaded_1._afterPluginsLoaded(function (oids) {
              return __awaiter(this, void 0, void 0, function* () {
                const certOids = yield this.getExtendedKeyUsage();
                let result;
                if (Array.isArray(oids)) {
                  result = oids.every((oidToCheck) =>
                    certOids.some((certOid) => certOid === oidToCheck)
                  );
                } else {
  ...
  \**********************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          __export(
            __webpack_require__(
              /*! ./certificate */ "./api/certificate/certificate.ts"
            )
          );
  ...
  \************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
           ...
           */
          exports.isValid = _afterPluginsLoaded_1._afterPluginsLoaded(
            function () {
              const cadesCertificate = this._cadesCertificate;
              return eval(
                _generateCadesFn_1._generateCadesFn(function isValid() {
                  let isValid;
                  try {
                    isValid =
                      _generateCadesFn_1.__cadesAsyncToken__ +
                      cadesCertificate.IsValid();
                    isValid =
                      _generateCadesFn_1.__cadesAsyncToken__ + isValid.Result;
                  } catch (error) {
                    console.error(error);
                    throw new Error(
                      _extractMeaningfulErrorMessage_1._extractMeaningfulErrorMessage(
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          /* WEBPACK VAR INJECTION */ (function (Buffer) {
            ...
            const _getCadesCert_1 = __webpack_require__(
              /*! ../helpers/_getCadesCert */ "./helpers/_getCadesCert.ts"
            );
            const _getDateObj_1 = __webpack_require__(
              /*! ../helpers/_getDateObj */ "./helpers/_getDateObj.ts"
            );
            /**
             ...
             */
            exports.createAttachedSignature =
              _afterPluginsLoaded_1._afterPluginsLoaded(
                (thumbprint, unencryptedMessage) =>
                  __awaiter(void 0, void 0, void 0, function* () {
                    const { cadesplugin } = window;
                    const cadesCertificate =
                      yield _getCadesCert_1._getCadesCert(thumbprint);
                    return eval(
                      _generateCadesFn_1._generateCadesFn(
                        function createAttachedSignature() {
                          let cadesAttrs;
                          let cadesSignedData;
                          let cadesSigner;
                          try {
                            cadesAttrs =
                              _generateCadesFn_1.__cadesAsyncToken__ +
                              _generateCadesFn_1.__createCadesPluginObject__(
                          ...
                          const currentTime = _getDateObj_1._getDateObj(
                            new Date()
                          );
                          try {
                            void (
                              _generateCadesFn_1.__cadesAsyncToken__ +
                              cadesAttrs.propset_Name(
                                constants_1.CADESCOM_AUTHENTICATED_ATTRIBUTE_SIGNING_TIME
                              )
                            );
                            void (
                              _generateCadesFn_1.__cadesAsyncToken__ +
                          ...
                          try {
                            messageBase64 =
                              Buffer.from(unencryptedMessage).toString(
                                "base64"
                              );
                          } catch (error) {
                            console.error(error);
                            throw new Error(
                              "Ошибка при преобразовании сообщения в Base64"
                            );
                          }
                          let cadesAuthAttrs;
                          try {
                            ...
                            cadesAuthAttrs =
                              _generateCadesFn_1.__cadesAsyncToken__ +
                              cadesSigner.AuthenticatedAttributes2;
                            void (
                              _generateCadesFn_1.__cadesAsyncToken__ +
                            ...
                            void (
                              _generateCadesFn_1.__cadesAsyncToken__ +
                              cadesSignedData.propset_ContentEncoding(
                                cadesplugin.CADESCOM_BASE64_TO_BINARY
                              )
                            );
                            void (
                              _generateCadesFn_1.__cadesAsyncToken__ +
                              cadesSignedData.propset_Content(messageBase64)
                            );
                            void (
                              _generateCadesFn_1.__cadesAsyncToken__ +
                            ...
                            throw new Error(
                              _extractMeaningfulErrorMessage_1._extractMeaningfulErrorMessage(
                                error
                              ) || "Ошибка при указании данных для подписи"
                            );
                          }
                          let signature;
                          try {
  ...
  \****************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
           ...
           * @returns подпись в формате PKCS#7
           */
          exports.createDetachedSignature =
            _afterPluginsLoaded_1._afterPluginsLoaded(
              (thumbprint, messageHash) =>
                __awaiter(void 0, void 0, void 0, function* () {
                  const { cadesplugin } = window;
                  const cadesCertificate = yield _getCadesCert_1._getCadesCert(
                    thumbprint
                  );
                  return eval(
                    _generateCadesFn_1._generateCadesFn(
  ...
  \***************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          /* WEBPACK VAR INJECTION */ (function (Buffer) {
             ...
             * @returns хеш
             */
            exports.createHash = _afterPluginsLoaded_1._afterPluginsLoaded(
              (unencryptedMessage) =>
                __awaiter(void 0, void 0, void 0, function* () {
                  const { cadesplugin } = window;
                  return eval(
                    _generateCadesFn_1._generateCadesFn(function createHash() {
                      const cadesHashedData =
                        _generateCadesFn_1.__cadesAsyncToken__ +
                        _generateCadesFn_1.__createCadesPluginObject__(
                          "CAdESCOM.HashedData"
                        );
                      ...
                      try {
                        messageBase64 =
                          Buffer.from(unencryptedMessage).toString("base64");
                      } catch (error) {
                        console.error(error);
                        throw new Error(
                          "Ошибка при преобразовании сообщения в Base64"
                      ...
                      try {
                        ...
                        void (
                          _generateCadesFn_1.__cadesAsyncToken__ +
                          cadesHashedData.propset_DataEncoding(
                            cadesplugin.CADESCOM_BASE64_TO_BINARY
                          )
                        );
                        void (
                        ...
                        throw new Error(
                          _extractMeaningfulErrorMessage_1._extractMeaningfulErrorMessage(
                            error
                          ) || "Ошибка при инициализации хэширования"
                        );
                      }
                      try {
                        hash =
                          _generateCadesFn_1.__cadesAsyncToken__ +
                          cadesHashedData.Value;
                      } catch (error) {
                        console.error(error);
                        throw new Error(
                          _extractMeaningfulErrorMessage_1._extractMeaningfulErrorMessage(
  ...
  \********************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
           ...
           * @returns подпись
           */
          exports.createSignature = _afterPluginsLoaded_1._afterPluginsLoaded(
            (thumbprint, messageHash, detachedSignature = true) =>
              __awaiter(void 0, void 0, void 0, function* () {
                console.warn(
                  [
                  ...
                  _generateCadesFn_1._generateCadesFn(
                    function createSignature() {
                      ...
                      try {
                        ...
                        void (
                          _generateCadesFn_1.__cadesAsyncToken__ +
                          cadesSignedData.propset_Content(messageHash)
                        );
                        void (
                          _generateCadesFn_1.__cadesAsyncToken__ +
                          cadesSigner.propset_Options(
                    ...
                    _generateCadesFn_1._generateCadesFn(
                      function createXMLSignature() {
                        ...
                        try {
                          ...
                          void (
                            _generateCadesFn_1.__cadesAsyncToken__ +
                            cadesSigner.propset_CheckCertificate(true)
                          );
                          void (
                            _generateCadesFn_1.__cadesAsyncToken__ +
                            cadesSignedXML.propset_Content(unencryptedMessage)
                          );
                          void (
                            _generateCadesFn_1.__cadesAsyncToken__ +
                          ...
                          void (
                            _generateCadesFn_1.__cadesAsyncToken__ +
                            cadesSignedXML.propset_SignatureMethod(
                              signatureMethod
                            )
                          );
                          void (
                            _generateCadesFn_1.__cadesAsyncToken__ +
                            cadesSignedXML.propset_DigestMethod(digestMethod)
                          );
                        } catch (error) {
                          console.error(error);
                          throw new Error(
                        ...
                        try {
                          signature =
                            _generateCadesFn_1.__cadesAsyncToken__ +
                            cadesSignedXML.Sign(cadesSigner);
                        } catch (error) {
                          console.error(error);
                          throw new Error(
                            _extractMeaningfulErrorMessage_1._extractMeaningfulErrorMessage(
  ...
  \************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
           ...
           */
          exports.execute = _afterPluginsLoaded_1._afterPluginsLoaded(
            (callback) =>
              __awaiter(void 0, void 0, void 0, function* () {
  ...
  \*******************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          const getUserCertificates_1 = __webpack_require__(
            /*! ./getUserCertificates */ "./api/getUserCertificates.ts"
          );
          /**
           ...
           * @returns сертификат
           */
          exports.getCertificate = _afterPluginsLoaded_1._afterPluginsLoaded(
            (thumbprint) =>
              __awaiter(void 0, void 0, void 0, function* () {
                if (!thumbprint) {
                ...
                const availableCertificates =
                  yield getUserCertificates_1.getUserCertificates();
                const foundCertificate = availableCertificates.find(
                  (cert) => cert.thumbprint === thumbprint
                );
                if (!foundCertificate) {
                  throw new Error(
                    `Сертификат с отпечатком: "${thumbprint}" не найден`
                  );
                }
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          exports.getSystemInfo = _afterPluginsLoaded_1._afterPluginsLoaded(
            () => {
              ...
              return eval(
                _generateCadesFn_1._generateCadesFn(function getSystemInfo() {
                  let cadesAbout;
                  try {
                    cadesAbout =
                      _generateCadesFn_1.__cadesAsyncToken__ +
                    ...
                    sysInfo.cadesVersion =
                      _generateCadesFn_1.__cadesAsyncToken__ +
                      cadesAbout.PluginVersion;
                    sysInfo.cspVersion =
                      _generateCadesFn_1.__cadesAsyncToken__ +
                      cadesAbout.CSPVersion();
                    ...
                    sysInfo.cadesVersion =
                      _generateCadesFn_1.__cadesAsyncToken__ +
                      sysInfo.cadesVersion.toString();
                    sysInfo.cspVersion =
                      _generateCadesFn_1.__cadesAsyncToken__ +
                      sysInfo.cspVersion.toString();
                  } catch (error) {
                    console.error(error);
                    throw new Error(
                      _extractMeaningfulErrorMessage_1._extractMeaningfulErrorMessage(
  ...
  \************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          const certificate_1 = __webpack_require__(
            /*! ./certificate */ "./api/certificate/index.ts"
          );
          const constants_1 = __webpack_require__(
            /*! ../constants */ "./constants/index.ts"
          );
          ...
          const _extractCommonName_1 = __webpack_require__(
            /*! ../helpers/_extractCommonName */ "./helpers/_extractCommonName.ts"
          );
          const _extractMeaningfulErrorMessage_1 = __webpack_require__(
            /*! ../helpers/_extractMeaningfulErrorMessage */ "./helpers/_extractMeaningfulErrorMessage.ts"
          );
          ...
          exports.getUserCertificates =
            _afterPluginsLoaded_1._afterPluginsLoaded((resetCache = false) => {
              const { cadesplugin } = window;
                      ...
                      if (cadesCertificates) {
                        ...
                        cadesCertificates =
                          ...
                          cadesCertificates.Find(
                            ...
                            constants_1.CAPICOM_PROPID_KEY_PROV_INFO
                          );
                        cadesCertificatesCount =
                          _generateCadesFn_1.__cadesAsyncToken__ +
                          cadesCertificates.Count;
                      }
                    } catch (error) {
                      console.error(error);
                      throw new Error(
                    ...
                    try {
                      while (cadesCertificatesCount) {
                        ...
                        certificateList.push(
                          new certificate_1.Certificate(
                            cadesCertificate,
                            _extractCommonName_1._extractCommonName(
                              _generateCadesFn_1.__cadesAsyncToken__ +
  ...
  \**********************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          __export(
            __webpack_require__(
              /*! ./getCertificate */ "./api/getCertificate.ts"
            )
          );
          __export(
            __webpack_require__(
          ...
          __export(
            __webpack_require__(/*! ./getSystemInfo */ "./api/getSystemInfo.ts")
          );
          __export(
            __webpack_require__(
              /*! ./isValidSystemSetup */ "./api/isValidSystemSetup.ts"
            )
          );
          __export(
            __webpack_require__(
              /*! ./createSignature */ "./api/createSignature.ts"
            )
          );
          __export(
            __webpack_require__(
              /*! ./createXMLSignature */ "./api/createXMLSignature.ts"
            )
          );
          __export(
            __webpack_require__(
              /*! ./createDetachedSignature */ "./api/createDetachedSignature.ts"
            )
          );
          __export(
            __webpack_require__(
              /*! ./createAttachedSignature */ "./api/createAttachedSignature.ts"
            )
          );
          __export(
            __webpack_require__(/*! ./createHash */ "./api/createHash.ts")
          );
          __export(
            __webpack_require__(
              /*! ./certificate */ "./api/certificate/index.ts"
  ...
  \***********************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          const _isSupportedCadesVersion_1 = __webpack_require__(
            /*! ../helpers/_isSupportedCadesVersion */ "./helpers/_isSupportedCadesVersion.ts"
          );
          const _isSupportedCSPVersion_1 = __webpack_require__(
            /*! ../helpers/_isSupportedCSPVersion */ "./helpers/_isSupportedCSPVersion.ts"
          );
          const getSystemInfo_1 = __webpack_require__(
            /*! ./getSystemInfo */ "./api/getSystemInfo.ts"
          );
          /**
          ...
          exports.isValidSystemSetup =
            _afterPluginsLoaded_1._afterPluginsLoaded(() =>
              __awaiter(void 0, void 0, void 0, function* () {
                ...
                if (
                  !_isSupportedCadesVersion_1._isSupportedCadesVersion(
                ...
                if (
                  !_isSupportedCSPVersion_1._isSupportedCSPVersion(
  ...
  \**************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          exports.XmlDsigGost3410Url =
            "urn:ietf:params:xml:ns:cpxmlsec:algorithms:gostr34102001-gostr3411";
          exports.XmlDsigGost3410UrlObsolete =
            "http://www.w3.org/2001/04/xmldsig-more#gostr34102001-gostr3411";
          exports.XmlDsigGost3411Url =
            "urn:ietf:params:xml:ns:cpxmlsec:algorithms:gostr3411";
          exports.XmlDsigGost3411UrlObsolete =
  ...
  \****************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          __export(
            __webpack_require__(
              /*! ./cades-constants */ "./constants/cades-constants.ts"
            )
          );
          __export(
            __webpack_require__(
              /*! ./issuer-tags-translations */ "./constants/issuer-tags-translations.ts"
            )
          );
          __export(
            __webpack_require__(
              /*! ./oids-dictionary */ "./constants/oids-dictionary.ts"
            )
          );
          __export(
            __webpack_require__(
              /*! ./subject-tags-translations */ "./constants/subject-tags-translations.ts"
            )
          );
  ...
  \***********************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          exports.ISSUER_TAGS_TRANSLATIONS = [
            ...
            {
              possibleNames: ["ИНН", "INN", "ИНН организации"],
              translation: "ИНН",
            },
  ...
  \**************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          exports.OIDS_DICTIONARY = {
            ...
            "1.2.643.3.8.100.1.5":
              "Использование в системах электронной торговли",
            "1.2.643.3.8.100.1.6":
              'Использование в торгово-закупочной системе "ЭЛЕКТРА"',
            "1.2.643.3.8.100.1.7":
            ...
            "1.2.643.6.3.1.2.3":
              "Тип участника - Индивидуальный предприниматель",
  ...
  \****************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          Object.defineProperty(exports, "__esModule", { value: true });
          const _extractMeaningfulErrorMessage_1 = __webpack_require__(
            /*! ./_extractMeaningfulErrorMessage */ "./helpers/_extractMeaningfulErrorMessage.ts"
          );
            ...
            return function (...args) {
              return __awaiter(this, void 0, void 0, function* () {
                if (!isPluginLoaded) {
                  try {
                    __webpack_require__(
                      /*! ../vendor/cadesplugin_api */ "./vendor/cadesplugin_api.js"
                    );
                  } catch (error) {
                    console.error(error);
                    throw new Error(
                      _extractMeaningfulErrorMessage_1._extractMeaningfulErrorMessage(
                        ...
                        "Ошибка при подключении модуля для работы с Cades plugin"
                    );
                  }
                  isPluginLoaded = true;
                }
                ...
                if (!cadesplugin) {
                  throw new Error(
                    "Не подключен модуль для работы с Cades plugin"
                  );
                }
                if (!isSetLogLevel) {
  ...
  \***************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          Object.defineProperty(exports, "__esModule", { value: true });
          exports._extractCommonName = (subjectName) => {
            var _a;
            return (_a = subjectName.match(/CN=(.+?)(?:,|$)/)) === null ||
              _a === void 0
              ? void 0
              : _a[1];
          };
  ...
  \***************************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          exports._extractMeaningfulErrorMessage = (error) => {
            var _a;
            let errorContainer =
              ((_a = window.cadesplugin) === null || _a === void 0
                ? void 0
                : _a.getLastError) && window.cadesplugin.getLastError(error);
            if (
            ...
            const containsRussianLetters = /[а-яА-Я]/.test(
              errorContainer.message
            );
            if (!containsRussianLetters) {
              return null;
            }
            const searchResult = errorContainer.message.match(
              /^(.*?)(?:(?:\.?\s?\(?0x)|(?:\.?$))/
            );
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          exports._generateCadesFn = (callback) => {
            ...
            const callbackArguments =
              ((_a = callbackLiteral.match(/^function[\s\w]*?\((.*?)\)/)) ===
                null || _a === void 0
                ? void 0
                : _a[1]) || "";
            const callbackBody = callbackLiteral.replace(
              /^.*?{([\s\S]*?)}$/,
              "$1"
            );
  ...
  \**********************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          Object.defineProperty(exports, "__esModule", { value: true });
          const _afterPluginsLoaded_1 = __webpack_require__(
            /*! ./_afterPluginsLoaded */ "./helpers/_afterPluginsLoaded.ts"
          );
          const _extractMeaningfulErrorMessage_1 = __webpack_require__(
            /*! ./_extractMeaningfulErrorMessage */ "./helpers/_extractMeaningfulErrorMessage.ts"
          );
          const _generateCadesFn_1 = __webpack_require__(
            /*! ./_generateCadesFn */ "./helpers/_generateCadesFn.ts"
          );
          /**
           ...
           */
          exports._getCadesCert = _afterPluginsLoaded_1._afterPluginsLoaded(
            (thumbprint) => {
              const { cadesplugin } = window;
              return eval(
                _generateCadesFn_1._generateCadesFn(function _getCadesCert() {
                  let cadesStore;
                  try {
                    cadesStore =
                      _generateCadesFn_1.__cadesAsyncToken__ +
                  ...
                  if (!cadesStore) {
                    throw new Error(
                      "Не удалось получить доступ к хранилищу сертификатов"
                    );
                  }
                  try {
                    void (
  ...
  \*******************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          exports._isSupportedCSPVersion = (version) => {
            var _a;
            version =
              (_a = version.match(/\d+?\b(?:\.\d+)?/)) === null || _a === void 0
                ? void 0
                : _a[0];
  ...
  \***********************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          exports._parseCertInfo = (tagsTranslations, rawInfo) => {
            const extractedEntities = rawInfo.match(
              /([а-яА-Яa-zA-Z0-9\s.]+)=(?:("[^"]+?")|(.+?))(?:,|$)/g
            );
            if (extractedEntities) {
              return extractedEntities.map((group) => {
                var _a, _b, _c;
                const segmentsMatch = group
                  .trim()
                  .match(/^([а-яА-Яa-zA-Z0-9\s.]+)=(.+?),?$/);
                let title =
                  segmentsMatch === null || segmentsMatch === void 0
                    ? void 0
                    : segmentsMatch[1];
                ...
                const description =
                  (_b =
                    (_a =
                      segmentsMatch === null || segmentsMatch === void 0
                        ? void 0
                        : segmentsMatch[2]) === null || _a === void 0
                      ? void 0
                      : _a.replace(/^"(.*)"/, "$1")) === null || _b === void 0
                    ? void 0
                    : _b.replace(/"{2}/g, '"');
                const oidIdentifierMatch =
                  title === null || title === void 0
                    ? void 0
                    : title.match(/^OID\.(.*)/);
                const oidIdentifier =
                  oidIdentifierMatch === null || oidIdentifierMatch === void 0
                    ? void 0
                    : oidIdentifierMatch[1];
                let isTranslated = false;
                // Если нашли в тайтле ОИД, пытаемся его расшифровать
                if (oidIdentifier) {
                  const oidTranslation =
                    constants_1.OIDS_DICTIONARY[oidIdentifier];
                  if (oidTranslation) {
          ...
          (function () {
            ...
            function set_log_level(level) {
              ...
              if (isNativeMessageSupported()) {
                if (
                  cadesplugin.current_log_level === cadesplugin.LOG_LEVEL_DEBUG
                )
                  window.postMessage("set_log_level=debug", "*");
                if (
                  cadesplugin.current_log_level === cadesplugin.LOG_LEVEL_INFO
                )
            ...
            function CreateObject(name) {
              if (isIOS()) {
                ...
                return call_ru_cryptopro_npcades_10_native_bridge(
                  "CreateObject",
                  [name]
                );
              }
            ...
            var ru_cryptopro_npcades_10_native_bridge = {
              ...
              resultForCallback: function resultForCallback(
                callbackId,
                resultArray
              ) {
                var callback =
            ...
            function call_ru_cryptopro_npcades_10_native_bridge(
              functionName,
              array
            ) {
              var tmpobj;
              ...
              if (!window.cadesplugin_skip_extension_install) {
                document.addEventListener("DOMContentLoaded", function () {
                  ...
                  ovr.innerHTML =
                    ...
                    "</div>";
                  document.getElementsByTagName("Body")[0].appendChild(ovr);
                  var btn_install = document.getElementById(
                    "cadesplugin_install"
                  );
              ...
              window.addEventListener(
                ...
                function (event) {
                  ...
                  if (isFireFox || isEdge || isSafari) {
                    ...
                    var url = event.data.substring(
                      event.data.indexOf("url:") + 4
                    );
            ...
            function plugin_loaded_error(msg) {
              if (isNativeMessageSupported()) {
                ...
                if (
                  isOpera &&
                  (typeof msg === "undefined" || typeof msg === "object")
                ) {
            ...
            function check_npapi_plugin() {
              try {
                ...
                document.getElementById("cadesplugin_object").style.display =
                  "none";
